  ...
  module Api
    ...
    class Feed
      ...
      def find(options = {})
        ...
        response = @client.get "/api/topics/#{@topic_id}/feeds/#{@id}", body, options
      ...
      def create(feed, options = {})
        ...
        response = @client.post "/api/topics/#{@topic_id}/feeds", body, options
      ...
      def delete(options = {})
        ...
        response = @client.delete "/api/topics/#{@topic_id}/feeds/#{@id}", body, options
